import { ArrowLeft, Code2, ExternalLink, GitBranch, Layers, Star, X } from "lucide-react";

// variant: "page" (full page, back button) | "modal" (overlay, close button)
export const ProjectContent = ({ project, onBack, variant = "page" }) => {
    const { title, description, image, liveDemo, repository, techStack, keyFeatures } = project;
    const isModal = variant === "modal";

    return (
        <section className={isModal ? "relative py-8 sm:py-10" : "relative py-16 pt-28"}>
            <div className={isModal ? "px-5 sm:px-8" : "container"}>
                ...
                <div className="mt-8 grid gap-10 lg:grid-cols-[1fr_1fr] lg:gap-12">
                    <div className="lg:order-1">
                        ...
                        <p className="mt-6 max-w-xl text-sm leading-7 text-white/70 sm:text-base text-start">
                            {description}
                        </p>
